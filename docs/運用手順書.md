...
Zenn・note・GitHub リポジトリの最新コンテンツを取得して差分があれば Amplify 再ビルドを Webhook でトリガーします。
...
**何もしなくてよい。** Zenn・note に記事を投稿するか、GitHub リポジトリに `neko-homepage` Topic を付けるだけで、翌日 21:00 JST 以降に自動反映されます。
