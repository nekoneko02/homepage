...
| ドキュメント | 概要 |
|---|---|
| [要件定義書](./docs/01_requirements.md) | 機能要件・非機能要件・受け入れ基準 |
| [仕様書](./docs/02_specification.md) | 画面仕様・データ取得仕様・カテゴリ付与仕様 |
| [設計書](./docs/03_design.md) | アーキテクチャ・レイヤ構成・デプロイ設計 |
| [コンテンツ取得方針](./docs/04_content-sources.md) | プラットフォーム別の取得方式 |
| **[運用手順書](./docs/05_operations.md)** | **コンテンツ追加・環境変数・トラブルシューティング** |
